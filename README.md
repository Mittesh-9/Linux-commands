...
2. **ls**: The `ls` command is used to list files or directories. It also accepts some flags or options that changes how files or directories are listed in your terminal.
    ...
    ```bash
     ...
     //Home directory
     $ ls ~
     Desktop    Downloads  Pictures  mittesh    test   test.txt
...
<img src="https://github.com/mitteshj/Linux-cheat-sheet/blob/master/images/permissions.png" width="600" height="400">
